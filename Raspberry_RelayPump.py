...
#Hardcoded start times for testing. This format should be passed by user.
...
# main loop
while True:
    #if already finished watering, fetch new watering time.
    #See how to implement this for multiple times a year. ! ! ! ! ! ! ! !
